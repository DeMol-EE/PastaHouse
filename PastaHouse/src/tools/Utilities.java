...
public class Utilities {
     ...
     * The tax number should contain 9 numbers. All dots, commas and dotcommas
     * are removed. Let left be the first 7 digits of the tax number and right
     * be the last 2. The check97 algorithm specifies the number is valid if
     * left%97 + right = 97 (or thus if the right part is the 97-complement of
     * left mod 97).
     *
